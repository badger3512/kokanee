...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
    ...
    <se:Name>gu_stateorterritory</se:Name>
    <NamedLayer>
        <se:Name>gu_stateorterritory</se:Name>
        <UserStyle>
            <se:Name>StateOrTerritory</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>State-Boundary</se:Name>
                    <ogc:Filter>
                        <ogc:Or>
                            ...
                            <ogc:Or>
                                <ogc:PropertyIsEqualTo>
                                    ...
                                    <ogc:Literal>61101</ogc:Literal>
                                </ogc:PropertyIsEqualTo>
                                <ogc:PropertyIsEqualTo>
                                    <ogc:Function name="parseInt">
                                        <ogc:PropertyName>fcode</ogc:PropertyName>
                                    </ogc:Function>
                                    <ogc:Literal>61102</ogc:Literal>
                                </ogc:PropertyIsEqualTo>
                            </ogc:Or>
                        </ogc:Or>
                    </ogc:Filter>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            ...
                            <se:SvgParameter name="stroke-dasharray">25 3 5 3 5 3</se:SvgParameter>
                        </se:Stroke>
                    </se:LineSymbolizer>
                    <se:TextSymbolizer>
                        <se:Label>
                            <ogc:PropertyName>state_name1</ogc:PropertyName>
                        </se:Label>
                        <se:Font>
                    ...
                    <se:TextSymbolizer>
                        <se:Label>
                            <ogc:PropertyName>state_name2</ogc:PropertyName>
                        </se:Label>
                        <se:Font>
                            <se:SvgParameter name="font-family">Times New Roman</se:SvgParameter>
                            <se:SvgParameter name="font-size">12.0</se:SvgParameter>
