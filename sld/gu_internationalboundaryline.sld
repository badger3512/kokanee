...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
    ...
    <se:Name>gu_internationalboundaryline</se:Name>
    <NamedLayer>
        <se:Name>gu_internationalboundaryline</se:Name>
        <UserStyle>
            <se:Name>International Boundary</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>International-Boundary</se:Name>
                    <ogc:Filter>
                    ...
                    <se:TextSymbolizer>
                        <se:Label>
                            <ogc:PropertyName>country_name</ogc:PropertyName>
                        </se:Label>
                        <se:Font>
