...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
    ...
    <se:Name>trans_roadsegment_usfs</se:Name>
    <NamedLayer>
        <se:Name>trans_roadsegment_usfs</se:Name>
        <UserStyle>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>Local Road-Federal</se:Name>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsEqualTo>
                                <ogc:PropertyName>tnmfrc</ogc:PropertyName>
                            ...
                            <ogc:Not>
                                <ogc:PropertyIsNull>
                                    <ogc:PropertyName>federal_lands_route</ogc:PropertyName>
                                </ogc:PropertyIsNull>
                            </ogc:Not>
                        </ogc:And>
                    </ogc:Filter>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>Local Road-Full-Street</se:Name>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsEqualTo>
                                <ogc:PropertyName>tnmfrc</ogc:PropertyName>
